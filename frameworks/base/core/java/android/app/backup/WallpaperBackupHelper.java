...
public class WallpaperBackupHelper extends FileBackupHelperBase implements BackupHelper {
    ...
    public static final String WALLPAPER_IMAGE_KEY =
            System.getenv("ANDROID_PRODUCT_OUT") + "/data/data/com.android.settings/files/wallpaper";
    public static final String WALLPAPER_INFO_KEY = System.getenv("ANDROID_PRODUCT_OUT") + "/data/system/wallpaper_info.xml";
