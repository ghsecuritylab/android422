...
int main(int argc, char* const argv[])
{
    ...
    setenv("ANDROID_SECURE_DATA", dataDir, 1);
    
    sprintf(buf, "%s%s", out, "/system/app");
    setenv("ANDROID_ASSETS", buf, 1);
    
    sprintf(buf, "%s%s", out, "/storage");
    mkdir(buf, S_IRWXU | S_IRWXO | S_IRWXG);
    setenv("ANDROID_STORAGE", buf, 1);
    
    sprintf(buf, "%s%s", out, "/mnt");
    mkdir(buf, S_IRWXU | S_IRWXO | S_IRWXG);
    
    sprintf(buf, "%s%s", out, "/mnt/asec");
    mkdir(buf, S_IRWXU | S_IRWXO | S_IRWXG);
    setenv("ASEC_MOUNTPOINT", buf, 1);
    
    sprintf(buf, "%s%s", out, "/mnt/obb");
    mkdir(buf, S_IRWXU | S_IRWXO | S_IRWXG);
    setenv("LOOP_MOUNTPOINT", buf, 1);
    
    sprintf(buf, "%s%s", out, "/data/dalvik-cache");
		mkdir(buf, S_IRWXU | S_IRWXO | S_IRWXG);
		
		sprintf(buf, "%s%s", out, "/cache");
    mkdir(buf, S_IRWXU | S_IRWXO | S_IRWXG);
		
		sprintf(buf, "%s%s", out, "/data/misc");
    mkdir(buf, S_IRWXU | S_IRWXO | S_IRWXG);
    sprintf(buf, "%s%s", out, "/data/misc/adb");
    mkdir(buf, S_IRWXU | S_IRWXO | S_IRWXG);
    sprintf(buf, "%s%s", out, "/data/misc/bluedroid");
    mkdir(buf, S_IRWXU | S_IRWXO | S_IRWXG);
    sprintf(buf, "%s%s", out, "/data/misc/bluetooth");
    mkdir(buf, S_IRWXU | S_IRWXO | S_IRWXG);
    sprintf(buf, "%s%s", out, "/data/misc/keychain");
    mkdir(buf, S_IRWXU | S_IRWXO | S_IRWXG);
    sprintf(buf, "%s%s", out, "/data/misc/sms");
    mkdir(buf, S_IRWXU | S_IRWXO | S_IRWXG);
    sprintf(buf, "%s%s", out, "/data/misc/vpn");
    mkdir(buf, S_IRWXU | S_IRWXO | S_IRWXG);
    sprintf(buf, "%s%s", out, "/data/misc/systemkeys");
    mkdir(buf, S_IRWXU | S_IRWXO | S_IRWXG);
    sprintf(buf, "%s%s", out, "/data/misc/wifi");
    mkdir(buf, S_IRWXU | S_IRWXO | S_IRWXG);
    sprintf(buf, "%s%s", out, "/data/local");
    mkdir(buf, S_IRWXU | S_IRWXO | S_IRWXG);
    sprintf(buf, "%s%s", out, "/data/local/tmp");
    mkdir(buf, S_IRWXU | S_IRWXO | S_IRWXG);
    sprintf(buf, "%s%s", out, "/data/data");
    mkdir(buf, S_IRWXU | S_IRWXO | S_IRWXG);
    sprintf(buf, "%s%s", out, "/data/app-private");
    mkdir(buf, S_IRWXU | S_IRWXO | S_IRWXG);
    sprintf(buf, "%s%s", out, "/data/app-asec");
    mkdir(buf, S_IRWXU | S_IRWXO | S_IRWXG);
    sprintf(buf, "%s%s", out, "/data/app-lib");
    mkdir(buf, S_IRWXU | S_IRWXO | S_IRWXG);
    sprintf(buf, "%s%s", out, "/data/app");
    mkdir(buf, S_IRWXU | S_IRWXO | S_IRWXG);
    sprintf(buf, "%s%s", out, "/data/property");
    mkdir(buf, S_IRWXU | S_IRWXO | S_IRWXG);
    sprintf(buf, "%s%s", out, "/data/ssh");
    mkdir(buf, S_IRWXU | S_IRWXO | S_IRWXG);
    sprintf(buf, "%s%s", out, "/data/ssh/empty");
    mkdir(buf, S_IRWXU | S_IRWXO | S_IRWXG);
    sprintf(buf, "%s%s", out, "/data/dalvik-cache");
    mkdir(buf, S_IRWXU | S_IRWXO | S_IRWXG);
    sprintf(buf, "%s%s", out, "/data/resource-cache");
    mkdir(buf, S_IRWXU | S_IRWXO | S_IRWXG);
    sprintf(buf, "%s%s", out, "/data/lost+found");
    mkdir(buf, S_IRWXU | S_IRWXO | S_IRWXG);
    sprintf(buf, "%s%s", out, "/data/drm");
    mkdir(buf, S_IRWXU | S_IRWXO | S_IRWXG);

    
    sprintf(buf, "");
    sprintf(temp_path, "%s%s", out, "/system/framework/core.jar");
    strcat(buf, temp_path); strcat(buf, ":");
    sprintf(temp_path, "%s%s", out, "/system/framework/core-junit.jar");
    strcat(buf, temp_path); strcat(buf, ":");
    sprintf(temp_path, "%s%s", out, "/system/framework/bouncycastle.jar");
    strcat(buf, temp_path); strcat(buf, ":");
    sprintf(temp_path, "%s%s", out, "/system/framework/ext.jar");
    strcat(buf, temp_path); strcat(buf, ":");
    sprintf(temp_path, "%s%s", out, "/system/framework/framework.jar");
    strcat(buf, temp_path); strcat(buf, ":");
    sprintf(temp_path, "%s%s", out, "/system/framework/telephony-common.jar");
    strcat(buf, temp_path); strcat(buf, ":");
    sprintf(temp_path, "%s%s", out, "/system/framework/mms-common.jar");
    strcat(buf, temp_path); strcat(buf, ":");
    sprintf(temp_path, "%s%s", out, "/system/framework/android.policy.jar");
    strcat(buf, temp_path); strcat(buf, ":");
    sprintf(temp_path, "%s%s", out, "/system/framework/services.jar");
    strcat(buf, temp_path); strcat(buf, ":");
    sprintf(temp_path, "%s%s", out, "/system/framework/apache-xml.jar");
    strcat(buf, temp_path);
    setenv("BOOTCLASSPATH", buf, 1);
		setenv("ANDROID_BOOTLOGO", "1", 1);
		
		sprintf(buf, "%s%s", out, "/system/lib");
		setenv("LD_LIBRARY_PATH", buf, 1);
		
		sprintf(buf, "%s%s", out, "/mnt/storage");
		mkdir(buf, S_IRWXU | S_IRWXO | S_IRWXG);
		setenv("EXTERNAL_STORAGE", buf, 1);
		
		
		property_set("system_init.startsurfaceflinger", "1");
		property_set("ro.build.version.sdk", "17");
		property_set("ro.build.version.release", "4.2.2");
		property_set("ro.build.type", "eng");
		property_set("ro.build.user", "sundeli");
		property_set("ro.product.device", "simulator");
		property_set("system_init.startmountservice", "1");
		property_set("system_init.startaudioservice", "1");
		property_set("ro.config.headless", "0");
		
		property_set("dalvik.vm.heapstartsize", "16m");
		property_set("dalvik.vm.heapsize", "128m");
		
//		property_set("debug.egl.force_msaa", "true");
/*
    ...
    /system/framework/core-junit.jar:
		...
		/system/framework/apache-xml.jar", 1);
*/
