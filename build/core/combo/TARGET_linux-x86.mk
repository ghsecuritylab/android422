...
#TARGET_TOOLS_PREFIX := prebuilts/tools/gcc-sdk/
TARGET_TOOLS_PREFIX := /usr/bin/

TARGET_CC := $(TARGET_TOOLS_PREFIX)gcc$(HOST_EXECUTABLE_SUFFIX)
TARGET_CXX := $(TARGET_TOOLS_PREFIX)g++$(HOST_EXECUTABLE_SUFFIX) -fpermissive
...
#KERNEL_HEADERS_COMMON := /usr/src/linux-headers-4.2.0-27-generic/include
#KERNEL_HEADERS_ARCH   := /usr/src/linux-headers-4.2.0-27-generic/include/asm-generic

#KERNEL_HEADERS_COMMON := /usr/include 
#KERNEL_HEADERS_ARCH   := /usr/include/asm-generic /usr/include/x86_64-linux-gnu/asm /usr/include/linux /usr/include/x86_64-linux-gnu
...
TARGET_GLOBAL_CFLAGS += $(TARGET_ANDROID_CONFIG_CFLAGS) -isystem /usr/include
