...
class ServerThread extends Thread {
    ...
    public void run() {
        ...
        try {
			...
			Slog.i(TAG, "display.waitForDefaultDisplay");
...
*/
            ...
            try {
                ...
                ServiceManager.addService(Context.DROPBOX_SERVICE,
                        new DropBoxManagerService(context, new File(System.getenv("ANDROID_PRODUCT_OUT") + "/data/system/dropbox")));
            } catch (Throwable e) {
        ...
        try {
			Slog.i(TAG, "display.systemReady");
