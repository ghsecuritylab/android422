...
public class DeviceStorageMonitorService extends Binder {
    ...
    private static final String DATA_PATH = System.getenv("ANDROID_PRODUCT_OUT")+"/data";
    private static final String SYSTEM_PATH = System.getenv("ANDROID_PRODUCT_OUT") + "/system";
    private static final String CACHE_PATH = System.getenv("ANDROID_PRODUCT_OUT")+"/cache";
