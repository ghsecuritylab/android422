...
// Running in single-process mode
            Log.e(LOG_TAG,"Starting VM process through single process:" + processClass + ",args:" + zygoteArgs);
            Runnable runnable = new Runnable() {
                        public void run() {
							Log.e(LOG_TAG,"Starting VM process through single process:" + processClass);
	...
	private static void invokeStaticMain(String className) {
		...
		Log.e(LOG_TAG,"invokeStaticMain:" + className);
		...
		try {
            ...
            throw new RuntimeException("Exception invoking static main on " 
                    + className, ex);
        }
		Log.e(LOG_TAG,"invokeStaticMain:" + className + ", done");
		//throw new Process.MethodAndArgsCaller(m, args);
    }
