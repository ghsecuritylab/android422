...
public class BootReceiver extends BroadcastReceiver {
    ...
    private static final File TOMBSTONE_DIR = new File(System.getenv("ANDROID_PRODUCT_OUT") + "/data/tombstones");
    ...
    private void logBootEvents(Context ctx) throws IOException {
        ...
        if (SystemProperties.getLong("ro.runtime.firstboot", 0) == 0) {
            ...
            addFileToDropBox(db, prefs, headers, System.getenv("ANDROID_PRODUCT_OUT") + "/cache/recovery/log",
                    -LOG_SIZE, "SYSTEM_RECOVERY_LOG");
            addFileToDropBox(db, prefs, headers, System.getenv("ANDROID_PRODUCT_OUT") + "/data/dontpanic/apanic_console",
                    -LOG_SIZE, "APANIC_CONSOLE");
            addFileToDropBox(db, prefs, headers, System.getenv("ANDROID_PRODUCT_OUT") + "/data/dontpanic/apanic_threads",
