...
public class CertPinInstallReceiverTest extends AndroidTestCase {
    ...
    private String readCurrentVersion() throws Exception {
        return IoUtils.readFileAsString(System.getenv("ANDROID_PRODUCT_OUT") + "/data/misc/keychain/metadata/version");
    }
    ...
    private static String getHashOfCurrentContent() throws Exception {
        String content = IoUtils.readFileAsString(System.getenv("ANDROID_PRODUCT_OUT") + "/data/misc/keychain/pins");
