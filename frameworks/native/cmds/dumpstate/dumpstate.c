...
static void dumpstate() {
    ...
    dump_file("LAST PANIC CONSOLE", System.getenv("ANDROID_PRODUCT_OUT") + "/data/dontpanic/apanic_console");
    dump_file("LAST PANIC THREADS", System.getenv("ANDROID_PRODUCT_OUT") + "/data/dontpanic/apanic_threads");
    ...
    run_command("SYSTEM SETTINGS", 20, SU_PATH, "root", "sqlite3",
            System.getenv("ANDROID_PRODUCT_OUT") + "/data/data/com.android.providers.settings/databases/settings.db",
    ...
    run_command("PACKAGE SETTINGS", 20, SU_PATH, "root", "cat", System.getenv("ANDROID_PRODUCT_OUT") + "/data/system/packages.xml", NULL);
    dump_file("PACKAGE UID ERRORS", System.getenv("ANDROID_PRODUCT_OUT") + "/data/system/uiderrors.txt");
